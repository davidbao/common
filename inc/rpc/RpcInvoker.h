...
namespace Rpc {
    ...
    public:
        ...
        RpcAsyncElement(const Uuid &token, const IRpcAsyncRequestData *request, const IRpcAsyncResponseData *response,
    ...
    public:
        ...
        RpcSyncMethod(const String &name, const IRpcSyncRequestData &request, const IRpcSyncResponseData &response,
                      sync_callback action, void *owner = nullptr);
    ...
    public:
        ...
        RpcAsyncMethod(const String &name, const IRpcAsyncRequestData &request, const IRpcAsyncResponseData &response,
                       async_callback action, void *owner = nullptr);
    ...
    public:
        ...
        RpcNotifyMethod(const String &name, const IRpcNotifyInfo &request, notify_callback action,
                        void *owner = nullptr);
    ...
    public:
        ...
        virtual RpcStatus
        invoke(const RpcMethodContext &context, const IRpcSyncRequestData &request, IRpcSyncResponseData &response);
    ...
    protected:
        virtual bool sendSync(const RpcMethodContext &context, const RpcSyncRequest &request, RpcSyncResponse &response,
                              const String &name) = 0;
    ...
    protected:
        virtual bool onSyncSetValue(const RpcMethodContext &context, Stream *stream, IRpcSyncRequestData *request,
                                    IRpcSyncResponseData *&response) = 0;

        virtual bool onAsyncRequestSetValue(const RpcMethodContext &context, Stream *stream, const Uuid &token,
                                            const Endpoint &peerEndpoint) = 0;
