...
namespace Common
{
    ...
    public:
        ...
        public:
            ...
            Context(const Endpoint& endpoint = Endpoint::Empty, const Secure& secure = Secure::None, TimeSpan timeout = TimeSpan::fromSeconds(30));
    ...
    public:
        ...
        static Uuid addSession(const String& userName, const TimeSpan& expiredTime = TimeSpan::Zero, bool kickout = false);
