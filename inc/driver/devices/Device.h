...
namespace Drivers {
    ...
    public:
        ...
        public:
            ...
            explicit StatusSnap(Status status);
        ...
        public:
            explicit ReceivedEventArgs(const ByteArray &buffer) {
                this->buffer = buffer;
            }
    ...
    private:
        ...
        InstructionContext *
        executeInstruction(Instruction *instruction, InstructionContext *ic, const ByteArray *buffer = nullptr);
