...
namespace Common
{
	...
	{
	public:
        static unsigned short checkByBit(const uint8_t* buffer, off_t offset, size_t count, unsigned short initValue = 0x0, unsigned short polynomial = 0xA001);
        static unsigned short checkByBit(const ByteArray& buffer, unsigned short initValue = 0x0, unsigned short polynomial = 0xA001);
        static unsigned short quickCheckByBit(const uint8_t* buffer, off_t offset, size_t count, unsigned short initValue = 0x0);
    ...
    {
    public:
        static uint8_t checkByBit(const uint8_t* buffer, off_t offset, size_t count, uint8_t initValue = 0x0, uint8_t polynomial = 0x8C);
