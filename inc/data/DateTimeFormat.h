...
namespace Common {
    ...
    */
    ...
    public:
        ...
        static const char allStandardFormats[];
        ...
        static void HebrewFormatDigits(String &outputBuffer, int digits);
        ...
        static String FormatHebrewMonthName(const DateTime& time, int month, int repeatCount, const DateTimeFormatInfo &dtfi);
        ...
        static String Format(DateTime dateTime, const String &format, const DateTimeFormatInfo &dtfi);
        ...
        static void appendNumber(String &builder, long val, int digits);

        static bool
        GetAllDateTimes(const DateTime &dateTime, char format, const DateTimeFormatInfo &dtfi, StringArray &result);

        static bool GetAllDateTimes(DateTime dateTime, const DateTimeFormatInfo &dtfi, StringArray &result);
...
//        static void InvalidFormatForLocal(const String& format, const DateTime& dateTime) {
//        }
//
//        // This is an MDA for cases when the user is using a local format with
//        // a Utc DateTime.
//        static void InvalidFormatForUtc(const String& format, const DateTime& dateTime) {
//#if MDA_SUPPORTED
