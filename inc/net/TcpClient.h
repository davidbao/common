...
namespace Common
{
	...
	{
	public:
		TcpClient(int sockId = -1, bool ipv4 = true);
		~TcpClient() override;
    ...
    {
    public:
        WebSocketClient(int sockId = -1, bool ipv4 = true, const TimeSpan& receiveTimeout = TimeSpan::fromSeconds(1));
    ...
    {
    public:
        WebSocketSSLClient(SSLVersion version = SSLVersion::TLSv1_2, int sockId = -1, bool ipv4 = true, const TimeSpan& receiveTimeout = TimeSpan::fromSeconds(1));
