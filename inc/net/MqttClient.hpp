...
namespace Net
{
    ...
    public:
        ...
        bool publishMessage(const String& topic, const String& payload, Qos qos = Qos::Qos1, const TimeSpan& timeout = TimeSpan::fromSeconds(10));
        bool publishMessage(const String& topic, const ByteArray& payload, Qos qos = Qos::Qos1, const TimeSpan& timeout = TimeSpan::fromSeconds(10));
