...
namespace Net {
    ...
    public:
        ...
        ssize_t receiveByEndBytes(uint8_t *buffer, size_t bufferLength, const uint8_t *startBuffer, size_t sbLength,
        ...
        ssize_t receiveBySize(uint8_t *buffer, size_t bufferLength, off_t offset, size_t count, uint32_t timeout,
                              const EscapeOption *escape = nullptr);
    ...
    private:
        ...
        bool receiveStartBytes(uint8_t *buffer, size_t bufferLength, const uint8_t *startBuffer, size_t sbLength,
                               uint32_t timeout);

        ssize_t
        receiveBySizeWithEscape(uint8_t *buffer, size_t bufferLength, off_t offset, size_t count, uint32_t timeout,
                                const EscapeOption *escape = nullptr);

        ssize_t
        receiveBySizeWithoutEscape(uint8_t *buffer, size_t bufferLength, off_t offset, size_t count, uint32_t timeout);
