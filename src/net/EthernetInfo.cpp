...
namespace Common
{
    ...
    void Timeout::operator=(const Timeout& value)
    {
        this->copyFrom(&value);
    }
    ...
    const String Timeout::toString() const
    {
    ...
    const String TcpInfo::toString() const
    {
        return String::convert("address: %s, port: %d", address.c_str(), port);
    }
    void TcpInfo::operator=(const TcpInfo& value)
    {
        this->copyFrom(&value);
    }
    ...
    const String TcpServerInfo::toString() const
    {
        return String::convert("address: %s, port: %d, maxConnections: %d", address.c_str(), port, maxConnections);
    }
    void TcpServerInfo::operator=(const TcpServerInfo& value)
    {
        this->copyFrom(&value);
    }
    ...
    void TcpServerInfo::copyFrom(const TcpInfo* value)
    {
        ...
        const TcpServerInfo* info = dynamic_cast<const TcpServerInfo*>(value);
        assert(info);
    ...
    const String UdpInfo::toString() const
    {
        return String::convert("address: %s, port: %d", address.c_str(), port);
    }
    void UdpInfo::operator=(const UdpInfo& value)
    {
        this->copyFrom(&value);
    }
    ...
    const String UdpServerInfo::toString() const
    {
        return String::convert("address: %s, port: %d", address.c_str(), port);
    }
    void UdpServerInfo::operator=(const UdpServerInfo& value)
    {
        this->copyFrom(&value);
    }
