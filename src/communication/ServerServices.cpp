...
namespace Communication
{
    ...
    const ServerServices::TypeString ServerServices::TypeString::WebSocket = ServerServices::TypeString(Type::WebSocket, "ws");
    const ServerServices::TypeString ServerServices::TypeString::SSL = ServerServices::TypeString(Type::SSL, "ssl");
    const ServerServices::TypeString ServerServices::TypeString::WebSocketSSL = ServerServices::TypeString(Type::WebSocketSSL, "wss");
    ...
    ServerServices::TypeStrings::TypeStrings(const TypeString& tcp, const TypeString& ssl) : TypeStrings(tcp, TypeString::Empty, ssl, TypeString::Empty)
    {
    }
    ServerServices::TypeStrings::TypeStrings(const TypeString& tcp, const TypeString& ws, const TypeString& ssl, const TypeString& wss)
    {
    ...
    void ServerServices::updateConfig(const BaseCommConfig& config, const String& prefix, const TypeStrings& typeStrings)
    {
        ...
        {
            _servers[WebSocketIndex] = config.server(String::convert(fmt, prefix.c_str(), typeStrings[WebSocketIndex].str.c_str()));
        }
        if((_type & SSL) == SSL &&
        ...
        {
            _servers[WebSocketSSLIndex] = config.server(String::convert(fmt, prefix.c_str(), typeStrings[WebSocketSSLIndex].str.c_str()));
        }
    }
