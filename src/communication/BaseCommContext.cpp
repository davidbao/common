...
namespace Communication
{
    ...
    BasePacketContext::BasePacketContext() : _packetLength(DefaultPacketLength), _packetCount(0), _packetNo(0), _transfer(0)
    {
    }
    ...
    {
        return packetCount == other.packetCount && packetNo == other.packetNo && fileLength == other.fileLength && fileName == other.fileName;
    }
