...
namespace Config {
    ...
    ConfigFile::ConfigFile(const String &pathName, const String &fileName, FileType type) : ConfigFile(nullptr,
                                                                                                       pathName,
                                                                                                       fileName, type) {
    }

    ConfigFile::ConfigFile(const String &fullFileName, FileType type) : ConfigFile(nullptr,
    ...
    ConfigFile::ConfigFile(Zip *z, const String &rpath, const String &fileName, FileType t) : ConfigSource(z, rpath,
                                                                                                           t) {
