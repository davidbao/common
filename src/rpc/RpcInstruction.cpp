...
namespace Rpc {
    ...
    RpcAsyncRequestContext *RpcReceiverEventContainer::onAsyncRequestSetValue(RpcAsyncRequestContext *context) {
        if (context != nullptr) {
            ...
            Stream *stream = context->stream();
            _receiver->onAsyncRequestSetValue(request->methodContext(), stream, request->token(),
                                              context->peerEndpoint());
        }
        return context;
    }
    ...
    // heartbeat
    HeartbeatInstruction::HeartbeatInstruction(InstructionDescription *id)
    ...
    ServerHeartbeatInstruction::ServerHeartbeatInstruction(InstructionDescription *id)
    ...
    // close
    CloseInstruction::CloseInstruction(InstructionDescription *id)
    ...
    ServerCloseInstruction::ServerCloseInstruction(InstructionDescription *id, IRpcServerEvent *receiver)
    ...
    // sync
    RpcSyncInstruction::RpcSyncInstruction(InstructionDescription *id)
    ...
    ServerRpcSyncInstruction::ServerRpcSyncInstruction(InstructionDescription *id, IRpcReceiverEvent *receiver)
    ...
    // async request
    RpcAsyncRequestInstruction::RpcAsyncRequestInstruction(InstructionDescription *id)
    ...
    ServerRpcAsyncRequestInstruction::ServerRpcAsyncRequestInstruction(InstructionDescription *id,
                                                                       IRpcReceiverEvent *receiver)
    ...
    // async response
    RpcAsyncResponseInstruction::RpcAsyncResponseInstruction(InstructionDescription *id)
    ...
    ServerRpcAsyncResponseInstruction::ServerRpcAsyncResponseInstruction(InstructionDescription *id,
                                                                         IRpcSenderEvent *receiver)
    ...
    ServerRpcNotifyInstruction::ServerRpcNotifyInstruction(InstructionDescription *id, IRpcReceiverEvent *receiver)
    ...
    ServerRpcSyncInstruction2::ServerRpcSyncInstruction2(InstructionDescription *id, IRpcReceiverEvent *receiver)
    ...
    RpcAsyncRequestInstruction2::RpcAsyncRequestInstruction2(InstructionDescription *id) : RpcAsyncRequestInstruction(
            id) {
    }
    ...
    ServerRpcAsyncRequestInstruction2::ServerRpcAsyncRequestInstruction2(InstructionDescription *id,
                                                                         IRpcReceiverEvent *receiver)
    ...
    RpcAsyncResponseInstruction2::RpcAsyncResponseInstruction2(InstructionDescription *id)
    ...
    ServerRpcAsyncResponseInstruction2::ServerRpcAsyncResponseInstruction2(InstructionDescription *id,
                                                                           IRpcSenderEvent *receiver)
    ...
    ServerRpcNotifyInstruction2::ServerRpcNotifyInstruction2(InstructionDescription *id, IRpcReceiverEvent *receiver)
