...
namespace Common
{
    ...
    unsigned short Crc16Utilities::checkByBit(const uint8_t* buffer, off_t offset, size_t count, unsigned short initValue, unsigned short polynomial)
    {
        for (off_t i = offset; i < count + offset; i++)
        {
    ...
    unsigned short Crc16Utilities::checkByBit(const ByteArray& buffer, unsigned short initValue, unsigned short polynomial)
    {
        return checkByBit(buffer.data(), 0, buffer.count(), initValue, polynomial);
    }
    unsigned short Crc16Utilities::quickCheckByBit(const uint8_t* buffer, off_t offset, size_t count, unsigned short initValue)
    {
    ...
    uint8_t Crc8Utilities::checkByBit(const uint8_t* buffer, off_t offset, size_t count, uint8_t initValue, uint8_t polynomial)
    {
        for (int i = offset; i < count + offset; i++)
        {
