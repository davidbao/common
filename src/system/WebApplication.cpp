...
//    	emscripten::function("set_url_parameters", &__set_url_parameters);
    ...
    WebApplication::WebApplication(const String& name, int argc, const char * argv[]) : Application(argc, argv, WebApplication::_homePath, WebApplication::_traceContexts), _name(name), _arguments(true)
    {
