...
namespace Common
{
    ...
    int Console::getopt_long(int nargc, char * const * nargv, const char * options, const struct option * long_options, int * idx)
    {
        return ::getopt_long(nargc, nargv, options, long_options, idx);
    }
    int Console::getopt_long_only(int nargc, char * const * nargv, const char * options, const struct option * long_options, int * idx)
    {
