...
//#endif
    ...
    MessageException::MessageException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    BindingException::BindingException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    OverflowException::OverflowException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    StreamException::StreamException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    IOException::IOException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    ArgumentException::ArgumentException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ArgumentException::ArgumentException(const String& message, const String& paramName, const Exception* innerException) : Exception(message, innerException)
    {
    ...
    ArgumentNullException::ArgumentNullException(const String& paramName) : ArgumentException(ArgumentNull_Generic, paramName)
    {
        showExceptionInfo();
    }
    ...
    ArgumentOutOfRangeException::ArgumentOutOfRangeException(const String& paramName, const String& message, const Exception* innerException) : ArgumentException(paramName, message, innerException)
    {
        showExceptionInfo();
    }
    ArgumentOutOfRangeException::ArgumentOutOfRangeException(const ArgumentOutOfRangeException& e) : ArgumentException(e)
    {
    }
    ...
    TimeoutException::TimeoutException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    NotImplementedException::NotImplementedException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    NotSupportedException::NotSupportedException(const String& message, const Exception* innerException) : Exception(message, innerException)
    {
        showExceptionInfo();
    }
    ...
    FileNotFoundException::FileNotFoundException(const String& fileName, const Exception* innerException) : Exception(fileName, innerException)
    {
        showExceptionInfo();
    }
