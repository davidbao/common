...
namespace Common {
    ...
    bool NumberFormat::equals(const NumberFormat &other) const {
        return false;
    }

    void NumberFormat::evaluates(const NumberFormat &other) {
    }

    int NumberFormat::compareTo(const NumberFormat &other) const {
        return 0;
    }

    Culture::Data::Data(uint lcid, const String &name, const String &region, const String &language, uint ansiPageCode,
                        uint oemPageCode) {
        this->lcid = lcid;
        this->name = name;
        this->region = region;
    ...
    const NumberFormat &Culture::numberFormat() const {
