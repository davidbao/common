...
namespace Common
{
	Culture::Data::Data(uint lcid, const String& name, const String& region, const String& language, uint ansiPageCode, uint oemPageCode)
	{
		this->lcid = lcid;
		this->name = name;
		this->region = region;
    ...
    Culture::Data& Culture::Data::operator=(const Data& value)
	{
		...
		this->ansiPageCode = value.ansiPageCode;
		this->oemPageCode = value.oemPageCode;
        return *this;
	}
	bool Culture::Data::operator==(const Data& value) const
	{
		return this->lcid == value.lcid &&
				this->name == value.name &&
				this->region == value.region &&
				this->language == value.language &&
				this->ansiPageCode == value.ansiPageCode &&
    ...
    const Culture::Data* Culture::AllCultures[AllCulturesCount] =
    {
        ...
        new Culture::Data(0x082C, "az-Cyrl-AZ", "Azeri (Cyrillic, Azerbaijan)", "Azeri (Cyrillic)", 1251, 866),
        ...
        new Culture::Data(0x201A, "bs-Cyrl-BA", "Bosnian (Cyrillic, Bosnia and Herzegovina)", "Bosnian (Cyrillic)", 1251, 855),
        new Culture::Data(0x141A, "bs-Latn-BA", "Bosnian (Latin, Bosnia and Herzegovina)", "Bosnian (Latin)", 1250, 852),
        ...
        new Culture::Data(0x101A, "hr-BA", "Croatian (Latin, Bosnia and Herzegovina)", "Croatian (Latin)", 1250, 852),
        ...
        new Culture::Data(0x085D, "iu-Latn-CA", "Inuktitut (Latin, Canada)", "Inuktitut (Latin)", 1252, 437),
        ...
        new Culture::Data(0x042F, "mk-MK", "Macedonian (Former Yugoslav Republic of Macedonia)", "Macedonian (FYROM)", 1251, 866),
        ...
        new Culture::Data(0x0450, "mn-MN", "Mongolian (Cyrillic, Mongolia)", "Mongolian (Cyrillic)", 1251, 866),
        new Culture::Data(0x0850, "mn-Mong-CN", "Mongolian (Traditional Mongolian, PRC)", "Mongolian (Traditional Mongolian)", 0, 1),
        ...
        new Culture::Data(0x1C1A, "sr-Cyrl-BA", "Serbian (Cyrillic, Bosnia and Herzegovina)", "Serbian (Cyrillic)", 1251, 855),
        new Culture::Data(0x0C1A, "sr-Cyrl-SP", "Serbian (Cyrillic, Serbia)", "Serbian (Cyrillic)", 1251, 855),
        new Culture::Data(0x181A, "sr-Latn-BA", "Serbian (Latin, Bosnia and Herzegovina)", "Serbian (Latin)", 1250, 852),
        new Culture::Data(0x081A, "sr-Latn-SP", "Serbian (Latin, Serbia)", "Serbian (Latin)", 1250, 852),
        new Culture::Data(0x046C, "nso-ZA", "Sesotho sa Leboa (South Africa)", "Sesotho sa Leboa", 1252, 850),
        ...
        new Culture::Data(0x0428, "tg-Cyrl-TJ", "Tajik (Cyrillic, Tajikistan)", "Tajik (Cyrillic)", 1251, 866),
        new Culture::Data(0x085F, "tzm-Latn-DZ", "Tamazight (Latin, Algeria)", "Tamazight (Latin)", 1252, 850),
        ...
        new Culture::Data(0x0843, "uz-Cyrl-UZ", "Uzbek (Cyrillic, Uzbekistan)", "Uzbek (Cyrillic)", 1251, 866),
    ...
    uint Culture::ansiPageCode() const
    {
        return _data.ansiPageCode;
    }
    uint Culture::oemPageCode() const
    {
	...
	bool Culture::operator==(const Culture& value) const
	{
