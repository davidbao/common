...
namespace Common
{
    ...
    PointFs::PointFs(uint capacity) : Array<PointF>(capacity)
    {
    }
    PointFs::PointFs(const PointFs& array) : Array<PointF>(array)
    {
    }
    ...
    Points::Points(uint capacity) : Array<Point>(capacity)
    {
    }
    // point:{0, 0};point:{300, 300}
    // 0, 0;300, 300
