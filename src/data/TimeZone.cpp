    ...
    const String TimeZone::FileNames[] =
            {
                    ...
                    "Europe/London",
                    "Europe/Amsterdam", "Africa/Cairo", "Europe/Moscow", "Asia/Tehran", "Asia/Dubai", "Asia/Kabul",
                    "Asia/Karachi", "Asia/Calcutta", "Asia/Kathmandu", "Asia/Dhaka", "Asia/Yangon", "Asia/Bangkok",
                    "Asia/Shanghai", "Asia/Tokyo", "Australia/Adelaide", "Australia/Sydney", "Asia/Magadan",
...
//    };
    ...
    const int64_t TimeZone::Offsets[] =
            {
                    12 * TicksPerHour, 11 * TicksPerHour, 10 * TicksPerHour, 9 * TicksPerHour, 8 * TicksPerHour,
                    7 * TicksPerHour, 6 * TicksPerHour,
                    5 * TicksPerHour, 4 * TicksPerHour, 33 * TicksPerHour / 10, 3 * TicksPerHour, 2 * TicksPerHour,
                    1 * TicksPerHour,
                    0,
                    -1 * TicksPerHour, -2 * TicksPerHour, -3 * TicksPerHour, -33 * TicksPerHour / 10, -4 * TicksPerHour,
                    -43 * TicksPerHour / 10, -5 * TicksPerHour, -53 * TicksPerHour / 10, -545 * TicksPerHour / 100,
                    -6 * TicksPerHour, -63 * TicksPerHour / 10, -7 * TicksPerHour,
                    -8 * TicksPerHour, -9 * TicksPerHour, -93 * TicksPerHour / 10, -10 * TicksPerHour,
                    -11 * TicksPerHour, -12 * TicksPerHour, -13 * TicksPerHour
            };
    ...
    bool TimeZone::equals(const TimeZone &other) const {
        return (_ticksOffset == other._ticksOffset);
    }

    void TimeZone::evaluates(const TimeZone &other) {
        this->_ticksOffset = other._ticksOffset;
    }

    int TimeZone::compareTo(const TimeZone &other) const {
        if (_ticksOffset > other._ticksOffset) return 1;
        if (_ticksOffset < other._ticksOffset) return -1;
        return 0;
    }
    ...
    void TimeZone::update() {
        ...
        _ticksOffset = (int64_t) (difftime(utc, local) * TicksPerSecond);
#endif
    }
    ...
    DateTime TimeZone::toUtcTime(const DateTime &time) const {
        if (time.kind() == DateTime::Kind::Utc)
            return time;
        return {time.ticks() + _ticksOffset, DateTime::Utc};
    }

    DateTime TimeZone::toLocalTime(const DateTime &time) const {
        if (time.kind() == DateTime::Kind::Local)
            return time;
        return {time.ticks() - _ticksOffset, DateTime::Local};
    }
...
//        return String::convert("STD%d", hourOffset());
    ...
    String TimeZone::toTypeStr(Type type) {
        switch (type) {
            case GMT_B1200:
                return "GMT-12:00";
            case GMT_B1100:
