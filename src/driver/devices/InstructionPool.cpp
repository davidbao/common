...
namespace Drivers
{
    ...
    InstructionPool::Packet::Packet(DeviceDescription* dd, InstructionDescription* id, AutoDelete autoDelete, uint8_t priority)
	...
	InstructionPool::Packet* InstructionPool::addInstruction(InstructionDescription* id, Packet::AutoDelete autoDelete, uint8_t priority)
	{
    ...
    InstructionPool::Packet* InstructionPool::addInstruction(DeviceDescription* dd, InstructionDescription* id, Packet::AutoDelete autoDelete, uint8_t priority)
    {
        if(_pause || channelConnected())
        {
	...
	InstructionPool::Packet* InstructionPool::addInstructionInner(InstructionDescription* id, Packet::AutoDelete autoDelete, uint8_t priority)
	{
    ...
    InstructionPool::Packet* InstructionPool::addInstructionInner(DeviceDescription* dd, InstructionDescription* id, Packet::AutoDelete autoDelete, uint8_t priority)
    {
        if(id != nullptr && id->allowExecution() && _instructions != nullptr)
        {
