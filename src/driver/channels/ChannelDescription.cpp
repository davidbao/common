...
namespace Drivers {
    ChannelDescription::ChannelDescription(const String &name, const String &interactiveName) : _name(name),
                                                                                                _interactiveName(
                                                                                                        interactiveName),
    ...
    ChannelDescription::ChannelDescription(const String &name, const String &interactiveName, InteractiveType iType)
            : ChannelDescription(name, interactiveName) {
        _iType = iType;
    }

    ChannelDescription::ChannelDescription(const String &name, ChannelContext *context, Interactive *interactive,
