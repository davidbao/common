...
bool testStringGetter() {
    String str = "abc123";
    return str.at(3) == '1';
}

bool testStringSetter() {
    String str = "abc123";
    str[3] = '2';
    if(str != "abc223") {
        return false;
